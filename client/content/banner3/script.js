/**
 * 728x90 - An HTML banner
 * @version v0.0.0
 * @date 1-25-2016 at 9:7:25
 */
var container, content, bgExit, backgroundImage, colorOverlay, mainHeadline, subHeadline, pulse, flame, colorOverlayDelay = 2, colorOverlayDuration = .4, backgroundImageDuration = 15, backgroundImageScale = 1.15, mainHeadlineFadeDuration = .5, mainHeadlineTopTo = 12;
mainHeadlineTopDuration = 4;
var subHeadlineFadeDuration = 1.5, pulseDuration = .5, pulseStart = -30, pulseEnd = 130;
bannerInit = function () {
    ...
    n.to(pulse, pulseDuration, {
        css: {y: pulseStart + "px"},
        delay: 1.5
    }).to(pulse, pulseDuration, {css: {y: pulseEnd + "px"}});
